...
urlpatterns = [
    ...
    path('subscriptions-list/<str:username>', views.subscription_index, name='subscriptions'),
    ...
    path('recipes/favorite/<str:username>/', views.recipe_favor, name='recipe_favor'),
